...
namespace A1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                Func<String, XDocument> loadxml = s =>
                {
                    return XDocument.Load(s);
                };

                Func<String, XDocument> loadjson = s =>
                {
            ...
            {
                var w = new WebClient();
                XDocument xml = JsonConvert.DeserializeXNode(w.DownloadString(new Uri(s + o + f)), "root");
                ...
                Func<XElement, String, String> selector = (x, path) =>
                {
                ...
                Func<String, String, String, XDocument, XDocument> orderByKey = (title, xpath, spath, xDoc) =>
                {
